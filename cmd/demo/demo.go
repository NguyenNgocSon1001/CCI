...
import (
	...
	"github.com/NguyenNgocSon1001/DemoCCI/config"
	"github.com/NguyenNgocSon1001/DemoCCI/system"
...
var (
	configPath = flag.String("cfg", "/etc/DemoCCI/demo.toml", "a path to configuration file")
)
...
func setup(cfg *config.Config) {
	...
	goji.Get("/hello", func(c web.C, w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		io.WriteString(w, "Hello from VN!")
	})
}
